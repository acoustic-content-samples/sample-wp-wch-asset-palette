...
{
    add_meta_box("demo-meta-box", "WCH Asset Picker", "custom_meta_box_markup", "page", "normal", "high", null);
    add_meta_box("demo-meta-box", "WCH Asset Picker", "custom_meta_box_markup", "post", "normal", "high", null);
}
